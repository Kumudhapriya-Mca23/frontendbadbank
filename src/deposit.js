...
function Deposit(){
    ...
    useEffect(()=>{
        async function fetchData(){
            if(name && pass){
            await axios.get('https://server-73gl.onrender.com/data').then(res=>{console.log(res.data);
            setData(res.data);
   ...
   <div className="create" >
    <Card className='card' border="success" style={{ width: '38rem',height:'30rem',backgroundColor:'skyblue'}}>
